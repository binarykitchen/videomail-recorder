...
import { VideomailRecorderOptions } from "../../features/options/types";
...
class VideomailError extends Error {
  public readonly title = "Error from videomail-recorder npm package";
  ...
  public constructor(
    message: string,
    options: VideomailRecorderOptions,
    classList?: string[],
    errData?: ErrData,
  ) {
